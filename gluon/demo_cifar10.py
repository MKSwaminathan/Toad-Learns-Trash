...
im_fname ='dataset_browser_files/ADE_train_00000002.jpg'
im_fname ='dataset_browser_files/ADE_train_00020000.jpg'
im_fname ='dataset_browser_files/ADE_train_00018279.jpg'
...
net = get_model('fcn_resnet50_ade', classes=10, pretrained=True)
...
class_names = ['airplane', 'automobile', 'bird', 'cat', 'deer', 'dog', 'frog', 'horse', 'ship', 'can']
